<nav class="navbar fixed-top navbar-expand-lg navbar-agora">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <?php } else {?>
        <div class="ml-auto">
            <h2><?=$_SESSION['user']['username']?></h2><img class="navbar-pp" src="<?= $_SESSION['user']['pp']."pp.png" ?>" alt=""><form method="post"><button type="submit" name="logout" value="true" ><i class="fas fa-sign-out-alt"></i></button></form>
        </div>
        <?php } ?>
    </div>
    </div>
